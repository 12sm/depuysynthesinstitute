 ...
 */
function editFavorite(ele, isInsert) {
	var obj = new Object();
	...
	if (isInsert) {
		...
		obj.favoritesUrl = "/json?amid=favorites&requestType=reqBuild&view=true&uriTxt=" + encodeURI(obj.uriTxt) + "&typeCd=" + obj.typeCd + "&relId=" + obj.relId;
		new SMTHttpRequest().sendRequest(obj.favoritesUrl, null, SMTHttpRequest.Types.OBJ_CALLBACK_OBJ, obj);
	} else {
		obj.callBack = editFavoriteCallback;
		obj.favoritesUrl = "/json?amid=favorites&requestType=reqBuild&isDelete=true&uriTxt=" + obj.uriTxt;
		new SMTHttpRequest().sendRequest(obj.favoritesUrl, null, SMTHttpRequest.Types.OBJ_CALLBACK_OBJ, obj);
	}
}
/*
