          ...
          <div class="modal-footer">
            <div class="row">
              ...
              <div class="col-xs-3 col-sm-4">
                <button type="button" class="btn btn-black seq-cancel" data-dismiss="modal">Cancel</button>
              </div>
              <div class="col-xs-3 col-sm-4">
                <button type="button" class="btn btn-info seq-confirm" data-dismiss="modal">OK</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="smt_col1Wrapper">
          <div id="smt_col1" class="padding-wrap">
            ...
            <div class="modSpacer name-assignment">
              <div class="row">
                <div class="col-xs-12">
                  ...
                  <h6>
                    <p class="tiny-grey">Assigned on 03/21/2015, updated on 03/27/2015</p>
                  </h6>
                </div>
              </div>
            </div>
            ...
            <div class="modSpacer assigned-by">
              <div class="row">
                <div class="col-xs-12">
                  <h3>Assigned by: William Hodgins<span> (<a href="#">whodgins@depuysynthesinstitute.com</a>)</span></h3>
            ...
            <div class="modSpacer assignments sequential">
              ...
              <div class="row">
                <div class="col-xs-12">
                  <h6 class="completed">Mark As Completed</h6>
                </div>
              </div>
                      ...
                      <div class="contention col-xs-10 col-sm-10 col-md-10 col-lg-10">
                        <div class="row">
                          ...
                          <div class="col-xs-11">
                            ...
                            <div class="row content">
                              <div class="col-xs-12">
                                <h4><a href="/views/my-assignments/single.php">Case Insights: Proximal Ulna Monteggia Fracture</a></h4>
                              </div>
                            </div>
                            <div class="row content">
                            ...
                            <div class="course_interaction content">
                              <div class="share-like-list dropdown btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                  ...
                                  <li role="presentation">
                                    <a role="menuitem" tabindex="-1" href="javascript:shareTwitter('/chest-wall/qs/DSUSCMF03150339');"><img src="/img/tw.jpg">Twitter</a>
                                  </li>
                                  <li role="presentation">
                                    <a role="menuitem" tabindex="-1" href="javascript:shareEmail('/chest-wall/qs/DSUSCMF03150339');"><img src="/img/mail.jpg">Email</a>
                                  </li>
                                </ul>
                      ...
                      <div class="contention col-xs-10 col-sm-10 col-md-10 col-lg-10">
                        <div class="row">
                          <div class="checkBiz col-xs-1">
                            ...
                            <div class="row">
                              <div class="col-xs-12">
                                <div class="checkComplete">
                                  <div class="squaredFour">
                                    <label><input class="forget" type="checkbox" value="none" id="squaredFour2" name="check"></label>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="col-xs-11">
                            ...
                            <div class="row content">
                              <div class="col-xs-12">
                                <h4><a href="/views/my-assignments/single.php">ORTHOCORD Suture and Anthroscopic Knot Tying CA#13038B/DJ12808A</a></h4>
                              </div>
                            </div>
                            <div class="row content">
                              <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 pull-left list-thumb">
                              ...
                              <div class="col-xs-6 col-sm-8 col-md-10 col-lg-10">
                                <div class="row">
                                  <div class="col-xs-12">
                                    <p><span>eLearning, 50 credits</span></p>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-xs-12">
                      ...
                      <div class="contention col-xs-10 col-sm-10 col-md-10 col-lg-10">
                        <div class="row">
                          <div class="checkBiz col-xs-1">
                            ...
                            <div class="row">
                              <div class="col-xs-12">
                                <div class="checkComplete">
                                  <div class="squaredFour">
                                    <label><input class="forget" type="checkbox" value="none" id="squaredFour3" name="check"></label>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="col-xs-11">
                            ...
                            <div class="row content">
                              <div class="col-xs-12">
                                <h4><a href="/views/my-assignments/single.php">Case Insights: Distal Humerus Extra Articular</a></h4>
                              </div>
                            </div>
                            <div class="row content">
                              <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 pull-left list-thumb">
                      ...
                      <div class="contention col-xs-10 col-sm-10 col-md-10 col-lg-10">
                        <div class="row">
                          <div class="checkBiz col-xs-1">
                            ...
                            <div class="row">
                              <div class="col-xs-12">
                                <div class="checkComplete">
                                  <div class="squaredFour">
                                    <label><input class="forget" type="checkbox" value="none" id="squaredFour4" name="check"></label>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="col-xs-11">
                            ...
                            <div class="row content">
                              <div class="col-xs-12">
                                <h4><a href="/views/my-assignments/single.php">Clavicle: Segmental Pediatric</a></h4>
                              </div>
                            </div>
                            <div class="row content">
                              <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 pull-left list-thumb">
                          ...
                          <div class="checkBiz col-xs-1">
                            ...
                            <div class="row">
                              <div class="col-xs-12">
                                <div class="checkComplete">
                                  <div class="squaredFour">
                                    <label><input class="forget" type="checkbox" value="none" id="squaredFour5" name="check"></label>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="col-xs-11">
                            <div class="row content">
                              ...
                              <div class="col-xs-8 col-sm-8 col-md-10 col-lg-10">
                                <div class="row">
                                  <div class="col-xs-12">
                                    <h4><a href="/views/my-assignments/single.php">Codman Neuro MedStreamTM Therapy Maintenance Course</a></h4>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-xs-12">
                                    <p class="tiny-grey">Dallas, TX</p>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="contention col-xs-10 col-sm-10 col-md-10 col-lg-10">
                        <div class="row">
                          <div class="checkBiz col-xs-1">
                            ...
                            <div class="row">
                              <div class="col-xs-12">
                                <div class="checkComplete">
                                  <div class="squaredFour">
                                    <label><input class="forget" type="checkbox" value="none" id="squaredFour6" name="check"></label>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="col-xs-11">
                            ...
                            <div class="row content">
                              <div class="col-xs-12">
                                <h4><a href="/views/my-assignments/single.php">A.L.P.S. Elbow Plating System Surgical Technique</a></h4>
                              </div>
                            </div>
                            <div class="row content">
                              <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 pull-left list-thumb">
                              ...
                              <div class="col-xs-6 col-sm-8 col-md-10 col-lg-10">
                                <div class="row">
                                  <div class="col-xs-12">
                                    <p><span>PDF, 1.1 MB</span></p>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-xs-12">
                                    <p>Elbow Plating System. Product Rationale & Surgical Technique guide. Low profile plate design helps minimize discomfort and soft...</p>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="contention col-xs-10 col-sm-10 col-md-10 col-lg-10 grey-bg-content">
                        <div class="row">
                          <div class="checkBiz col-xs-1">
                            ...
                            <div class="row">
                              <div class="col-xs-12">
                                <div class="checkComplete">
                                  <div class="squaredFour">
                                    <label><input class="forget" type="checkbox" value="none" id="squaredFour7" name="check" checked></label>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="col-xs-11">
                            ...
                            <div class="row content">
                              <div class="col-xs-12">
                                <h4><a href="/views/my-assignments/single.php">Dr. Malcom Smith - Reduction of Femoral Neck Fractures</a></h4>
                              </div>
                            </div>
                            <div class="row content">
                              <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 pull-left list-thumb">
                            ...
                            <div class="course_interaction content">
                              <div class="share-like-list dropdown btn-group">
                                <span class="video_share dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown">
                                  <a href="#"><span class="glyphicon icon-share"></span> share</a></span>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                  <li role="presentation">
                                    <a role="menuitem" tabindex="-1" href="javascript:shareFacebook('/chest-wall/qs/DSUSCMF03150339');"><img src="/img/fb.jpg">Facebook</a>
                                  </li>
                      ...
                      <div class="contention col-xs-10 col-sm-10 col-md-10 col-lg-10 grey-bg-content">
                        <div class="row">
                          <div class="checkBiz col-xs-1">
                            ...
                            <div class="row">
                              <div class="col-xs-12">
                                <div class="checkComplete">
                                  <div class="squaredFour">
                                    <label><input class="forget" type="checkbox" value="none" id="squaredFour8" name="check" checked></label>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="col-xs-11">
                            ...
                            <div class="row content">
                              <div class="col-xs-12">
                                <h4><a href="/views/my-assignments/single.php">Sinflate® System</a></h4>
                              </div>
                            </div>
                            <div class="row content">
                              <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 pull-left list-thumb">
                              ...
                              <div class="col-xs-6 col-sm-8 col-md-10 col-lg-10">
                                ...
                                <div class="row">
                                  <div class="col-xs-12">
                                    <p>Vertebral augmentation system for the reduction of fractures and/or creation of a void in cancellous bone in the spine.</p>
                                  </div>
                                </div>
                              </div>
                            </div>
